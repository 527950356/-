    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/shop-order',
          name: 'shop-order',
          component: () => import(/* webpackChunkName: "order-evaluate" */ '@/pages/shop-order/index.vue'),
          meta:{
            title:[
              {
               titleName:'我的订单',
        ...
        },
        {
          path: '/shop-my',
          name: 'shop-my',
          component: () => import(/* webpackChunkName: "order-evaluate" */ '@/pages/shop-my/index.vue'),
          meta:{
            title:[
              {
               titleName:'我的信息',
        ...
        },
        {
          path: '/shop-driver',
          name: 'shop-driver',
          component: () => import(/* webpackChunkName: "order-evaluate" */ '@/pages/shop-driver/index.vue'),
          meta:{
            title:[
              {
               titleName:'司机信息',
        ...
        },
        {
          path: '/driver-my',
          name: 'driver-my',
          component: () => import(/* webpackChunkName: "order-evaluate" */ '@/pages/driver-my/index.vue'),
          meta:{
            title:[
              {
               titleName:'我的信息',
